...
{
    // what should i learn concept of global position and local position 
    // to use local position we use localPosition
    // to use global position we use just location
    // Deeply research about topic that mentor are assigning
